...
#datExpr = read.xlsx("data_Plasma_processed.xlsx")
datExpr = read.xlsx("Filtered_Data.xlsx", sheet = 'wgcna.Plasma')
#col 1 =  (lipids)
...
#=====================================================================================
#Save o database
save(datExpr, datTraits, file = "03_output_Input_plasma.RData")
