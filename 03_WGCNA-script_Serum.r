...
#=====================================================================================
# use soft thresholding power 13 and calculate the adjacencies
...
save(MEs, moduleLabels, moduleColors, geneTree, file = "04_output_networkConstruction_Serum.RData")
